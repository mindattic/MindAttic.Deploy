...
// ──────────────────────────────────────────────────────────────────────
// Static CSS for the widgets. Uses the Hardware theme's CSS variables
// (--fg / --muted / --muted2 for text; --bg* / --border / --accent* /
// --shadow shared) so it tracks light/dark via prefers-color-scheme.
// ──────────────────────────────────────────────────────────────────────
...
.part-cat-blurb { color: var(--muted2); font-weight: 400; font-size: 0.8em; }
.parts-grid { display: flex; flex-direction: column; gap: 14px; margin: 0.8em 0 2em; }
.part-card {
  display: flex; flex-direction: row; align-items: stretch;
  background: var(--bg2); border: 1px solid var(--border); border-radius: 10px;
  overflow: hidden; text-decoration: none; color: inherit;
  transition: box-shadow 0.18s; box-shadow: var(--shadow);
}
...
.part-specs > dt { color: var(--muted2); font-weight: 600; letter-spacing: 0.02em; white-space: nowrap; margin: 0; }
...
.parts-total-label { font-size: 0.78em; letter-spacing: 0.08em; text-transform: uppercase; color: var(--muted2); font-weight: 700; }
.parts-total-value { font-size: 1.6em; font-weight: 700; color: var(--accent); font-variant-numeric: tabular-nums; }
.parts-total-asof { margin-left: auto; color: var(--muted2); font-size: 0.82em; font-style: italic; }`;
